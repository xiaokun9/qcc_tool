...
P0D_P1_DM_RAM_LOWER                                                              = c_enum(None, 262144, "Lowest address for block    'P1 DATA RAM'.", "APPS_SYS_CPU0_DM")
P0D_P1_DM_RAM_UPPER                                                              = c_enum(None, 425984, "Highest address for block   'P1 DATA RAM'.", "APPS_SYS_CPU0_DM")
...
P1D_P1_DM_RAM_LOWER                                                              = c_enum(None, 262144, "Lowest address for block    'P1 DATA RAM'.", "APPS_SYS_CPU1_DM")
P1D_P1_DM_RAM_UPPER                                                              = c_enum(None, 425984, "Highest address for block   'P1 DATA RAM'.", "APPS_SYS_CPU1_DM")
...
PxD_P1_DM_RAM_LOWER                                                              = c_enum(None, 262144, "Lowest address for block    'P1 DATA RAM'.", "APPS_SYS_CPUx_DM")
PxD_P1_DM_RAM_UPPER                                                              = c_enum(None, 425984, "Highest address for block   'P1 DATA RAM'.", "APPS_SYS_CPUx_DM")
...
PxD_TCM1_LOWER                                                                   = c_enum(None, 537001984, "Lowest address for block    'TCM1'.", "APPS_SYS_CPUx_DM")
PxD_TCM1_UPPER                                                                   = c_enum(None, 537133056, "Highest address for block   'TCM1'.", "APPS_SYS_CPUx_DM")
...
PxP_TCM1_LOWER                                                                   = c_enum(None, 8519680, "Lowest address for block    'TCM1 (RAM = 128kB Region = 128kB)'.", "APPS_SYS_CPUx_PM")
PxP_TCM1_UPPER                                                                   = c_enum(None, 8650752, "Highest address for block   'TCM1 (RAM = 128kB Region = 128kB)'.", "APPS_SYS_CPUx_PM")
PxP_TCM1_SIZE                                                                    = c_enum(None, 131072, "Actual TCM1 size = 128KB", "APPS_SYS_CPUx_PM")
ADDR_SEL_MSB                                                                     = c_enum(None, 31, "", "ADDR_SEL")
ADDR_SEL_LSB                                                                     = c_enum(None, 27, "", "ADDR_SEL")
ADDR_SEL_PM_MSB                                                                  = c_enum(None, 24, "", "ADDR_SEL")
ADDR_SEL_PM_LSB                                                                  = c_enum(None, 17, "", "ADDR_SEL")
...
MAP_P1_DM_RAM_LOWER                                                              = c_enum(None, 262144, "Lowest address for P1 DM.", "APPS_SYS_MEM")
MAP_P1_DM_RAM_UPPER                                                              = c_enum(None, 425984, "Highest address for P1 DM.", "APPS_SYS_MEM")
...
MAP_TCM1_LOWER                                                                   = c_enum(None, 537001984, "Lowest address for TCM1.", "APPS_SYS_MEM")
MAP_TCM1_UPPER                                                                   = c_enum(None, 537133056, "Highest address for TCM1.", "APPS_SYS_MEM")
...
MAC_OPERAND_MODE                                                                 = c_reg(0xffff8068, 1, 1, 0, "RW", 4, 0, 0, 0, "k32_core", "", "Configures MAC/MSUB instructions to operate on packed bytes or halfwords. Also provides support for single-cycle 2 x (byte x byte) multiplications. Defaults to 32x32 multiplication for backward compatibility. See programming guidelines for usage. ", "", "", 0, 1, "", "", 0)
MAC_OPERAND_MODE.MAC_OPERAND_MODE_TYPES                                          = c_bits(MAC_OPERAND_MODE, 0, 2, 0x7, 3, "RW", "Specifies operand types for MAC/MSUB instructions.")
MAC_OPERAND_MODE.MAC_OPERAND_MODE_TYPES.MAC_DEFAULT                              = c_value(MAC_OPERAND_MODE, "MAC_DEFAULT", 0, "Single 32-bit x 32-bit multiplication (default).")
MAC_OPERAND_MODE.MAC_OPERAND_MODE_TYPES.MAC_16_16                                = c_value(MAC_OPERAND_MODE, "MAC_16_16", 1, "Single 16-bit x 16-bit multiplication.")
MAC_OPERAND_MODE.MAC_OPERAND_MODE_TYPES.MAC_32_16                                = c_value(MAC_OPERAND_MODE, "MAC_32_16", 2, "Single 32-bit x 16-bit multiplication.")
MAC_OPERAND_MODE.MAC_OPERAND_MODE_TYPES.MAC_32_8                                 = c_value(MAC_OPERAND_MODE, "MAC_32_8", 3, "Single 32-bit x 8-bit multiplication.")
MAC_OPERAND_MODE.MAC_OPERAND_MODE_TYPES.MAC_16_8                                 = c_value(MAC_OPERAND_MODE, "MAC_16_8", 4, "Single 16-bit x 8-bit multiplication.")
MAC_OPERAND_MODE.MAC_OPERAND_MODE_TYPES.MAC2_8_8                                 = c_value(MAC_OPERAND_MODE, "MAC2_8_8", 5, "Dual 8-bit x 8-bit multiplications.")
MAC_OPERAND_MODE.MAC_OPERAND_MODE_FRACT                                          = c_bits(MAC_OPERAND_MODE, 3, 3, 0x8, 1, "RW", "Operands to MAC are fixed-point fractions, by default they are assumed to be integers. MAC result for integers still need to be right shifted by 1.")
...
MAC_OPERAND_MODE_TYPES                                                           = c_enum(None, 0, "Specifies operand types for MAC/MSUB instructions.", "MAC_OPERAND_MODE_TYPES")
MAC_DEFAULT                                                                      = c_enum(None, 0, "Single 32-bit x 32-bit multiplication (default).", "MAC_OPERAND_MODE_TYPES")
MAC_16_16                                                                        = c_enum(None, 1, "Single 16-bit x 16-bit multiplication.", "MAC_OPERAND_MODE_TYPES")
MAC_32_16                                                                        = c_enum(None, 2, "Single 32-bit x 16-bit multiplication.", "MAC_OPERAND_MODE_TYPES")
MAC_32_8                                                                         = c_enum(None, 3, "Single 32-bit x 8-bit multiplication.", "MAC_OPERAND_MODE_TYPES")
MAC_16_8                                                                         = c_enum(None, 4, "Single 16-bit x 8-bit multiplication.", "MAC_OPERAND_MODE_TYPES")
MAC2_8_8                                                                         = c_enum(None, 5, "Dual 8-bit x 8-bit multiplications.", "MAC_OPERAND_MODE_TYPES")
MAC_OPERAND_MODE_FRACT                                                           = c_enum(None, 3, "Operands to MAC are fixed-point fractions, by default they are assumed to be integers. MAC result for integers still need to be right shifted by 1.", "MAC_OPERAND_MODE_TYPES")
...
SUPPORT_RAS                                                                      = c_reg(0xffff80ac, 1, 1, 0, "RW", 1, 1, 0, 0, "k32_misc", "", "Enables support for ReadAndSet (RAS) instruction in Audio subsystem.", "", "", 0, 1, "", "", 0)
SUPPORT_RAS.SUPPORT_RAS                                                          = c_bits(SUPPORT_RAS, 0, 0, 0x1, 1, "RW", "")
