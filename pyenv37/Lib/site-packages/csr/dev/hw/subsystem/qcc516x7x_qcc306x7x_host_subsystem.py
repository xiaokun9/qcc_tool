...
class QCC516x7x_QCC306x7xHostSubsystem(HostSubsystem):
...
class QCC516x7x_QCC306x7xHostSubsystemView(object):
    ...
    @property
    def bitserial2(self):
        return self._host_ss.get_subsystem_view("BITSERIAL2", self._ssid)
