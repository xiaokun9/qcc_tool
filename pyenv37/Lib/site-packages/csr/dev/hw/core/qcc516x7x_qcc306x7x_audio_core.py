...
class QCC516x7x_QCC306x7xAudioCore(IsInHydra, AudioVMCore):
    """
    Generic Audio core for QCC516x7x_QCC306x7x: relies on parametrisation of the following
    quantities:
    ...
    def _info(self):
        ...
        try:
            ...
            _core_info = QCC516x7x_QCC306x7xAudioCoreInfo(self._hw_version,
                                       custom_digits=self.emulator_build)
        return _core_info


class QCC516x7x_QCC306x7xAudioP0Core(QCC516x7x_QCC306x7xAudioCore):
...
class QCC516x7x_QCC306x7xAudioP1Core(QCC516x7x_QCC306x7xAudioCore):
...
class QCC516x7x_QCC306x7xAudioCoreInfo (Kalimba32CoreInfo, SupportsCustomDigits):
    """
    QCC516x7x_QCC306x7x Audio Core meta-data.
    """
    ...
    def io_map_info(self):
        ...
        try:
            ...
            if self.custom_io_struct:
                ...
                from ..io import qcc516x_qcc306x_audio_io_struct as io_struct
