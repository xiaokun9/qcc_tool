...
/* flGetAvailablePortsEx and flmGetAvailablePortsEx search criteria */
#define TFL_TRANS_CRIT_NOLOCK   0x00000001 /* include devices where no lock status
                                    is available for transport */
#define TFL_TRANS_CRIT_UNLOCKED 0x00000002
#define TFL_TRANS_CRIT_LOCKED   0x00000004
#define TFL_TRANS_CRIT_ALL      0x00000007 /* (TFL_TRANS_CRIT_NOLOCK|
                                    TFL_TRANS_CRIT_UNLOCKED|TFL_TRANS_CRIT_LOCKED) */
#define TFL_TRANS_CRIT_DEFAULT  0x00000003 /* (TFL_TRANS_CRIT_NOLOCK|
                                    TFL_TRANS_CRIT_UNLOCKED) */
...
*************************************************************************************/
TESTFLASH_API(int32) flGetAvailablePortsEx(uint32 criteria, uint16* maxLen, 
                                           char* ports, char* trans, uint16* count);
...
*************************************************************************************/
TESTFLASH_API(int32) flmGetAvailablePortsEx(uint32 criteria, uint16* maxLen,
                                            char* ports, char* trans, uint16* count);
...
*************************************************************************************/
TESTFLASH_API(int32) flGetFlashInfoEx(uint32* sectors, uint32* sizeMbits,
                                      uint32* manId, uint32* devId);
...
*************************************************************************************/
TESTFLASH_API(int32) flmGetDeviceFlashInfoEx(uint32 device, uint32* sectors,
                                           uint32* sizeMbits, uint32* manId,
                                           uint32* devId);
...
*************************************************************************************/
TESTFLASH_API(int32) flSetSubsysChipSel(uint8 subSys, uint8 chipSel);
...
*************************************************************************************/
TESTFLASH_API(int32) flmSetSubsysChipSel(uint32 deviceMask, uint8 subSys, uint8 chipSel);
...
#endif //SOURCE_CODE_RELEASE
#define flSetSubsysBank          flSetSubsysChipSel
#define flmConvertSpiPort        flmConvertPort
#define flmSetSubsysBank         flmSetSubsysChipSel
/* DEPRECATED_END */
